...
import { GlobalWebSocketEventEmitter, WebSocketEventEmitter } from './class'
...
export function decorateInstance (fastify: FastifyInstance, wsServer: Server): GlobalWebSocketEventEmitter {
  const event = new GlobalWebSocketEventEmitter(wsServer)
